...
2. Navigate to [lockedata/rstudiocloud-master](https://github.com/lockedata/rstudiocloud-master)
2. Hit the fork button and select your account
...
```
3. Time permitting, and your personal devices, perform [SSH key set up](https://help.github.com/articles/generating-a-new-ssh-key-and-adding-it-to-the-ssh-agent/)
4. In RStudio, select New Project from Source Control, then selct Git and paste in the URL of your forked version of this repository
